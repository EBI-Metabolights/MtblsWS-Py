...
if __name__ == "__main__":
    ...
    maintain_folders(study_id_list=study_ids, target="private-ftp", task_name="MAINTAIN_PRIVATE_FTP", output_summary_report="ftp_folder_maintenance.txt", apply_future_actions=True)
