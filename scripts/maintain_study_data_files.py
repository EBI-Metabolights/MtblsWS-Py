...
def maintain_study_data_files(
    ...
    with flask_app.app_context():
        ...
        with open(future_action_log_file_path, "w") as fa:
            header = f"STUDY_ID\tSTUDY STATUS\tACTION\tITEM\tMESSAGE\tPARAMETERS\n"
            ...
            for study_id in study_id_list:
                ...
                try:
                    maintenance_task.calculate_maintenace_actions_for_study_data_files()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 2 and sys.argv[2]:
        output_summary_report = sys.argv[2]  
    with flask_app.app_context():
        ...
        results = maintain_study_data_files(study_ids, flask_app=flask_app, output_summary_report=output_summary_report)
