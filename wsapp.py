...
def initialize_app(flask_app):
    ...
    api.add_resource(Validation, res_path + "/ebi-internal/<string:study_id>/validate_study")
    api.add_resource(OverrideValidation, res_path + "/ebi-internal/<string:study_id>/validate_study/override")
