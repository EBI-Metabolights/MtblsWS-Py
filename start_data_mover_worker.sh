...
cd $APPDIR
python3 -m celery -A app.tasks.worker:celery worker --loglevel debug -Q datamover-tasks --autoscale 2,20 --logfile $APP_LOG_DIR/celery_datamover_worker.log -n ${WORKER_NAME}@%h