...
class WsTests(unittest.TestCase):
    ...
    def create_app(self):
        ...
        self.app.config['LIVESERVER_PORT'] = 5005
    ...
    def test_request_about_OK(self):
        # assert self.app
        request = urllib.request.Request(self.url_about)
    ...
    def test_get_title(self):
        request = urllib.request.Request(self.url_pubId + '/title', method='GET')
        with urllib.request.urlopen(request) as response:
            self.assertEqual(response.code, 200)
    ...
    def test_get_title_pub_auth(self):
        request = urllib.request.Request(self.url_pubId + '/title', method='GET')
        request.add_header('user_token', self.CuratorID)
        with urllib.request.urlopen(request) as response:
            self.assertEqual(response.code, 200)
            header = response.info()
            self.check_header_common(header)
    ...
    def test_get_title_pub_noAuth(self):
        request = urllib.request.Request(self.url_pubId + '/title', method='GET')
        request.add_header('user_token', self.WrongAuth)
        with urllib.request.urlopen(request) as response:
            self.assertEqual(response.code, 200)
            header = response.info()
            self.check_header_common(header)
    ...
    def test_get_title_priv_auth(self):
        request = urllib.request.Request(self.url_privId + '/title', method='GET')
        request.add_header('user_token', self.CuratorID)
        with urllib.request.urlopen(request) as response:
            self.assertEqual(response.code, 200)
            header = response.info()
    ...
    def test_get_title_nullId(self):
        request = urllib.request.Request(self.url_nullId + '/title', method='GET')
        try:
            urllib.request.urlopen(request)
        except urllib.error.HTTPError as err:
    ...
    def test_get_title_badId(self):
        request = urllib.request.Request(self.url_badId + '/title', method='GET')
        try:
            urllib.request.urlopen(request)
        except urllib.error.HTTPError as err:
            self.assertEqual(err.code, 404)
    ...
    def test_get_desc(self):
        request = urllib.request.Request(self.url_pubId + '/description', method='GET')
        with urllib.request.urlopen(request) as response:
            self.assertEqual(response.code, 200)
            header = response.info()
            self.check_header_common(header)
    ...
    def test_get_desc_priv_auth(self):
        request = urllib.request.Request(self.url_privId + '/description', method='GET')
        request.add_header('user_token', self.CuratorID)
        with urllib.request.urlopen(request) as response:
            self.assertEqual(response.code, 200)
            header = response.info()
    ...
    def test_get_desc_nullId(self):
        request = urllib.request.Request(self.url_nullId + '/description', method='GET')
        try:
            urllib.request.urlopen(request)
        except urllib.error.HTTPError as err:
            self.assertEqual(err.code, 404)
    ...
    def test_get_desc_badId(self):
        request = urllib.request.Request(self.url_badId + '/description', method='GET')
        try:
            urllib.request.urlopen(request)
        except urllib.error.HTTPError as err:
            self.assertEqual(err.code, 404)
