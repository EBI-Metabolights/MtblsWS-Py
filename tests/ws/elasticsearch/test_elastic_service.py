...
class TestElasticService(object):
    ...
    def test_reindex_study_01(self, flask_app: Flask,
    ...
    def test_reindex_study_valid_authorization_02(self, flask_app: Flask,
                                                  elasticsearch_service: ElasticsearchService,
                                                  sensitive_data: SensitiveDatastorage, mocker):
        with flask_app.app_context():
            study_id = "MTBLS4654"
    ...
    def test_reindex_study_invalid_study_01(self, flask_app: Flask,
                                            elasticsearch_service: ElasticsearchService,
                                            sensitive_data: SensitiveDatastorage, mocker):
        with flask_app.app_context():
    ...
    def test_reindex_study_invalid_user_token_01(self, flask_app: Flask,
                                                 elasticsearch_service: ElasticsearchService,
                                                 sensitive_data: SensitiveDatastorage, mocker):
        with flask_app.app_context():
            study_id = "MTBLS1"
            ...
            mock_index_method.index = mocker.Mock()
            with pytest.raises(MetabolightsException) as context:
                study = elasticsearch_service.reindex_study(study_id=study_id, user_token="xyzs-invalid")
