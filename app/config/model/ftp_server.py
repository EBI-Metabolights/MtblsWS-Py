...
class PublicFtpServerConfiguration(BaseModel):
    ...
    public_studies_http_base_url: str = "http://ftp.ebi.ac.uk/pub/databases/metabolights/studies/public"
    public_studies_ftp_base_url: str = "ftp://ftp.ebi.ac.uk/pub/databases/metabolights/studies/public"
