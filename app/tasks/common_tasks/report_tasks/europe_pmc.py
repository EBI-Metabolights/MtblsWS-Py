...
def europe_pmc_publication_report(self, user_token: str, google_sheet_id: str):
    logger.info("Received request to process EuropePMC study publication search !")
    return EbEyeSearchService.europe_publication_report(user_token=user_token, google_sheet_id=google_sheet_id)