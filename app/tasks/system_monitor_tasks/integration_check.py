...
from app.tasks.system_monitor_tasks.integrity_tests.utils import (
    check_functions,
    function_categories,
...
@celery.task(
    name="app.tasks.common_tasks.admin_tasks.integration_check.check_integrations"
)
def check_integrations():
    ...
    for function_name in ordered_check_function_names:
        ...
        test_results[category][function_name] = check_functions[category][
            function_name
        ]()
