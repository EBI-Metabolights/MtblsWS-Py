...
class StudyUtils:
    ...
    def is_template_file(filename: str, id: str) -> bool:
        ...
        """
        return filename.upper().startswith(
            "I_INVESTIGATION"
        ) or filename.upper().startswith("S_{0}".format(id))
    ...
    def overwrite_investigation_file(study_location: str, study_id: str):
        ...
        try:
            ...
            for line in lines:
                ...
                if (
                    line_changes["Study Identifier"]["index"] > -1
                    and line_changes["Study File Name"]["index"] > -1
                ):
                    break
                index += 1
            ...
            if (
                ...
                logger.error(
                    "Index of required line not found in investigation.txt file."
                )
                raise IndexError
            ...
            logger.error(
                "Investigation file could not be opened. Check that the investigation file is present"
