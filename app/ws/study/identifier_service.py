...
from app.ws.study.identifier import Identifier
...
class DefaultIdentifier(Identifier):
    ...
    def get_id(
        ...
        creation_time: Union[None, datetime.datetime] = None,
    ) -> str:
...
default_mtbls_identifier = DefaultIdentifier(
    app_settings.study.accession_number_prefix,
    app_settings.study.accession_number_regex,
)
default_provisional_identifier = SubmissionIdentifier(
    app_settings.study.provisional_id_prefix, app_settings.study.provisional_id_regex
)
