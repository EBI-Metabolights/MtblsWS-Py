...
class About(Resource):
    ...
    def get(self):
        ...
        api = {
            "version": server_settings.description.metabolights_api_version,
        ...
        app = {
            "name": server_settings.description.ws_app_name,
            "version": server_settings.description.ws_app_version,
            "description": server_settings.description.ws_app_description,
            "url": server_settings.service.app_host_url
            + server_settings.service.resources_path,
        }
