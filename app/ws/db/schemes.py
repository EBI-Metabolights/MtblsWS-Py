...
class Study(Base):
    ...
    updatedate = Column(DateTime, nullable=False, server_default=text("('now'::text)::timestamp without time zone"))
    submissiondate = Column(DateTime, nullable=False, server_default=text("('now'::text)::timestamp without time zone"))
...
class RefMetabolite(Base):
    ...
    created_date = Column(DateTime, server_default=text("('now'::text)::timestamp without time zone"))
    updated_date = Column(DateTime, server_default=text("('now'::text)::timestamp without time zone"))
...
t_studies_temp_can_be_deleted = Table(
    'studies_temp_can_be_deleted', metadata,
