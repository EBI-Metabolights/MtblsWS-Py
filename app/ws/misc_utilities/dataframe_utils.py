...
class DataFrameUtils:
    ...
    def NMR_assay_cleanup(df: pandas.DataFrame) -> pandas.DataFrame:
        ...
        rename = {
            ...
            "Parameter Value[Temperature]": "Parameter.Value.Temperature.",
            "Unit": "Unit",
            "Label": "Label",
    ...
    @staticmethod
    def LCMS_maf_cleanup(
        df: pandas.DataFrame, study_id: str, maf_filename: str
    ) -> pandas.DataFrame:
        """
