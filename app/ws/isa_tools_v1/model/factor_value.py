...
class FactorValue(Commentable):
    ...
    def __repr__(self):
        return ("app.ws.isa_tools_v1.model.FactorValue(factor_name={factor_name}, value={value}, unit={unit})"
...
class StudyFactor(Commentable, Identifiable):
    ...
    def __repr__(self):
        return ("app.ws.isa_tools_v1.model.StudyFactor(name='{study_factor.name}', "
