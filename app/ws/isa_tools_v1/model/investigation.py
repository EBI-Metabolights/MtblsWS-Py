...
from app.ws.isa_tools_v1.model.mixins import MetadataMixin
from app.ws.isa_tools_v1.model.ontology_annotation import OntologySource
...
from app.ws.isa_tools_v1.graphQL.models import IsaSchema
...
class Investigation(Commentable, MetadataMixin, Identifiable, object):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.Investigation(" \
