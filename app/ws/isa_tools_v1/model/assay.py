...
from app.ws.isa_tools_v1.model.mixins import StudyAssayMixin
from app.ws.isa_tools_v1.model.ontology_annotation import OntologyAnnotation
from app.ws.isa_tools_v1.model.datafile import DataFile
from app.ws.isa_tools_v1.model.material import Material
...
class Assay(Commentable, StudyAssayMixin, object):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.Assay(measurement_type={measurement_type}, " \
