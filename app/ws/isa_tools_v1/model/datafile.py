...
class DataFile(Commentable, ProcessSequenceNode, Identifiable):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.DataFile(filename='{data_file.filename}', " \
...
class RawDataFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.RawDataFile(filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
...
class DerivedDataFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.DerivedDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class RawSpectralDataFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.RawSpectralDataFile(filename='{0.filename}', " \
...
class DerivedArrayDataFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.DerivedArrayDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class ArrayDataFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.ArrayDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class DerivedSpectralDataFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.DerivedSpectralDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class ProteinAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.ProteinAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class PeptideAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.PeptideAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class DerivedArrayDataMatrixFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.DerivedArrayDataMatrixFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class PostTranslationalModificationAssignmentFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.PostTranslationalModificationAssignmentFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class AcquisitionParameterDataFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.AcquisitionParameterDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
...
class FreeInductionDecayDataFile(DataFile):
    ...
    def __repr__(self):
        return "app.ws.isa_tools_v1.model.FreeInductionDecayDataFile(" \
               "filename='{data_file.filename}', " \
               "generated_from={data_file.generated_from}, " \
               "comments={data_file.comments})".format(data_file=self)
