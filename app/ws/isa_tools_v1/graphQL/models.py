...
from app.ws.isa_tools_v1.graphQL.custom_scalars import DateTime, StringOrInt
from app.ws.isa_tools_v1.graphQL.inputs import (
    AssayParameters,
...
from app.ws.isa_tools_v1.graphQL.utils.search import (
    search_assays,
...
class Process(ObjectType):
    from app.ws.isa_tools_v1.graphQL.unions import ProcessInputs, ProcessOutputs
