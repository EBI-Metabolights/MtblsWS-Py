...
class RemoteStorage(Storage):
    ...
    def __init__(self, name, remote_folder):
        ...
        remote_file_manager: MountedVolumeFileManager = MountedVolumeFileManager(manager_name, "")
        ...
        super(RemoteStorage, self).__init__(name=name, remote_file_manager=self.remote_file_manager)
