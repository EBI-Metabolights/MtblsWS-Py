...
class UnmountedStorage(Storage):
    ...
    def calculate_sync_status(self, study_id: str, obfuscation_code: str,
        ...
        if not ignore_list:
            ignore_list = []
        result = remote_job_manager.sync_anaysis_job_results(source_ftp_folder=ftp_folder_name, force=force, ignore_list=ignore_list)
        return result
    ...
    def check_folder_sync_status(self, study_id: str, obfuscation_code: str, target_local_path: str) -> SyncTaskResult:
        ...
        result = remote_job_manager.get_folder_sync_results()
        return result
