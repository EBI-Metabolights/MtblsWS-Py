...
export SIF_LATEST_FILE_NAME="${CI_PROJECT_NAME}_${CI_COMMIT_REF_NAME}_latest.sif"
export SIF_LATEST_FILE_URL="${CI_API_V4_URL}/projects/${CI_PROJECT_ID}/packages/generic/${CI_PROJECT_NAME}_sif/$CI_COMMIT_REF_NAME/$SIF_LATEST_FILE_NAME"
