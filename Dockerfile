...
RUN apt-get -y update \
    && apt-get -y install wget curl zip git vim rar unrar p7zip-full bzip2 pigz pbzip2 zstd rsync openssh-client libglib2.0-0 libsm6 libxrender1 libxext6 libpq-dev \
